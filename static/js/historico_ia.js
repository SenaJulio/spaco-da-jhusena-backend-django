...
(function () {
  ...
  let lastHistUrl = ""; // antirrepique de chamadas iguais
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    (function () {
      // Diagnóstico: confira se os elementos existem
      const req = {
      ...
      // “Ver Histórico” (se existir) → força uma carga antes de abrir
